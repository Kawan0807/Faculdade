...
public class TanqueEspanha implements PrototipoTanque {
    private CoresTanques corTanque,corCanhao;
    private float x,y;

    public TanqueEspanha(CoresTanques corTanque, CoresTanques corCanhao, float x, float y) {
